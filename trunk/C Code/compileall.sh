...
g++ nrutil.c -c -o nrutil.o;
g++ MathDoubleFuncs.c -c -o MathDoubleFuncs.o;
g++ MathFloatFuncs.c -c -o MathFloatFuncs.o;
g++ AudioChannel.o CircularBuffer.o ALFpackage.o DSPFunctions.o nrutil.o MathDoubleFuncs.o MathFloatFuncs.o -O3 -Wall -swc -o ALFPackage.swc;
